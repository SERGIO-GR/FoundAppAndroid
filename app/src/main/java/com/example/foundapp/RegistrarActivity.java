...
EditText txtLoginCorreo,txtLoginPass;
...
FirebaseAuth firebaseAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        awesomeValidation.addValidation(this,R.id.txtLoginPass,".{6,}",R.string.invalid_pass);
        ...
        btnCrearCuenta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String contraseña=txtLoginPass.getText().toString();
    ...
    private void dameToastdeerror(String error) {
        ...
        switch (error) {
            ...
            case "ERROR_WRONG_PASSWORD":
                ...
                txtLoginPass.setError("la contraseña es incorrecta ");
            ...
            case "ERROR_WEAK_PASSWORD":
                ...
                txtLoginPass.setError("La contraseña no es válida, debe tener al menos 6 caracteres");
                txtLoginPass.requestFocus();
                break;
